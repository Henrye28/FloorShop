...
public class SearchView extends LinearLayout {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        int defaultColor = context.getResources().getColor(R.color.defaultTextColor); // 默认颜色 = 灰色
        ...
        // 搜索框颜色
        int defaultColor2 = context.getResources().getColor(R.color.bg_color); // 默认颜色 = 白色
