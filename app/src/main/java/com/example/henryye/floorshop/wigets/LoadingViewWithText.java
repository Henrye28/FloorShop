...
public class LoadingViewWithText extends ViewGroup{
    ...
    private static final String LOAD_FAILED_TIP = "Loading failed\nPlease retry";
    ...
    public LoadingViewWithText(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LoadingViewWithText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            radius = t.getDimensionPixelSize(R.styleable.MaterialCircleView_radius,
                    LoadingCircleView.dpToPx(50, getResources()));
        } finally {
            if (t != null) {
                t.recycle();
            }
        ...
        loadingCircleView = new LoadingCircleView(context, attrs, defStyleAttr);
...
//        super.onMeasure(widthMeasureSpec, heightMeasureSpec);
        ...
        LayoutParams params = (LayoutParams) loadingCircleView.getLayoutParams();
        ...
        LayoutParams tipParams = (LayoutParams) mTipTextView.getLayoutParams();
        int tipWidth = LoadingCircleView.dpToPx(100, getResources());
        int tipHeight = LoadingCircleView.dpToPx(50, getResources());
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        LayoutParams params = (LayoutParams) loadingCircleView.getLayoutParams();
        loadingCircleView.layout(params.left, params.top, params.left + params.width
...
//        return super.onInterceptTouchEvent(ev);
    ...
    public android.view.ViewGroup.LayoutParams generateLayoutParams(
            AttributeSet attrs) {
        return new LoadingViewWithText.LayoutParams(getContext(), attrs);
    }
    ...
    protected boolean checkLayoutParams(android.view.ViewGroup.LayoutParams p) {
        return p instanceof LoadingViewWithText.LayoutParams;
    }
